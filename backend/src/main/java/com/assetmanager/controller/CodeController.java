...
import com.assetmanager.service.DynamoDBService;
...
public class CodeController {
    ...
    public ResponseEntity<List<String>> getCodes(
        ...
        return ResponseEntity.ok(dynamoDBService.getCodes(codeType));
    }
    ...
    public ResponseEntity<Void> updateCodes(
        ...
        dynamoDBService.saveCodes(codeType, request.get("codes"));
